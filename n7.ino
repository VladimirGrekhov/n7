...
void vSaveFotoSens() {
  EEPROM.update(0, igUst[0]);
  EEPROM.update(2, igUst[1]);
  EEPROM.update(4, igUst[2]);
  EEPROM.update(6, igUst[3]);
  EEPROM.update(8, igUst[4]);
  EEPROM.update(10, igUst[5]);
  EEPROM.update(12, _EPP_CON);
}
void vSaveServoPos() {
...
void vSaveFotoSensR() {
  EEPROM.update(39, igUstDif[0]);
  EEPROM.update(41, igUstDif[1]);
  EEPROM.update(43, igUstDif[2]);
  EEPROM.update(45, igUstDif[3]);
  EEPROM.update(47, igUstDif[4]);
  EEPROM.update(49, igUstDif[5]);
  EEPROM.update(51, _EPP_CON);
}
void vSavebygRum() {
